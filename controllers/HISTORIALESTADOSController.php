...
class HISTORIALESTADOSController extends Controller
{
    ...
    /**
     * Creates a new HISTORIALESTADOS model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new HISTORIALESTADOS();

        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->HES_ID]);
        } else {
    ...
    /**
     * Updates an existing HISTORIALESTADOS model.
    ...
    /**
     * Deletes an existing HISTORIALESTADOS model.
