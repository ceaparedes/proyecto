...
class SOLUCIONRECLAMOSUGERENCIAController extends Controller
{
    ...
    /**
     * Creates a new SOLUCIONRECLAMOSUGERENCIA model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new SOLUCIONRECLAMOSUGERENCIA();

        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->SOR_ID]);
        } else {
    ...
    /**
     * Updates an existing SOLUCIONRECLAMOSUGERENCIA model.
